  ...
  function RulesScreen(){
    return <><PageHeader title="Regras do CIDARANK" subtitle="Entenda de forma simples como funcionam rankings, conquistas, estabelecimentos e a comunidade."/>
      ...
      <div className="rulesGrid">
        ...
        <section className="panel ruleCard"><h3>⭐ Popular da Cidade</h3><p>É permanente e baseado em seguidores válidos. Não zera semanalmente, mensalmente ou anualmente.</p><b>Atualização contínua</b><small>Exclusivo da cidade de cadastro.</small></section>
        <section className="panel ruleCard futureRule"><h3>🗺️ Estado</h3><p>A estrutura fica visível, mas a competição estadual permanece bloqueada até a liberação oficial.</p><b>EM BREVE</b></section>
        <section className="panel ruleCard futureRule"><h3>🇧🇷 Brasil</h3><p>A estrutura nacional está preparada para expansão, mas o ranking Brasil permanece bloqueado até a liberação oficial.</p><b>EM BREVE</b></section>
