...
export default function Home(){
  ...
  function MessagesScreen(){
    ...
    const starters=people.filter(p=>p.id!==session.user.id&&tabOk(p)&&searchOk(p)).slice(0,20);
